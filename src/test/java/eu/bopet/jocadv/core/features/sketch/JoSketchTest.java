...
class JoSketchTest {
    ...
    void addConstraint() {
        ...
        PointToPointDistance pointToPointDistance1 = new PointToPointDistance(point1,point2,distance1, SketchConstraint.USER_DEFINED);
        sketch.addConstraint(pointToPointDistance1);
        JoValue distance2 = new JoValue(JoValue.USER,12.0);
        PointToPointDistance pointToPointDistance2 = new PointToPointDistance(point1,point3,distance2, SketchConstraint.USER_DEFINED);
        ...
        LineParallelToLine lineParallelToLine1 = new LineParallelToLine(SketchConstraint.USER_DEFINED,line1,line3);
        sketch.addConstraint(lineParallelToLine1);
        LineParallelToLine lineParallelToLine2 = new LineParallelToLine(SketchConstraint.USER_DEFINED,line2,line4);
